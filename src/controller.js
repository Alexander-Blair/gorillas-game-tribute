(function() {
  ...
  var angle = '';
  var run = false;
  var terrainUnitWidth = 24;
  var terrainUnitHeight = 16;
  var bananaStartXCoord = 1155;
  ...
  gorillas = [];
  gorillas.push(new Gorilla(1100, 550))
  gorillas.push(new Gorilla(50, 550))
  ...
  function draw() {
    ...
    if (run === true) {
      ...
      drawBall();
      if(banana.yCoord() > (terrainUnitHeight * 50)) {
        run = false;
      }
